...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnIngresar =
            findViewById<MaterialButton>(R.id.buttonLogout)

        val ivTogglePassword =
            findViewById<ImageView>(R.id.ivTogglePassword)
    ...
    // Configura el salto automático entre cajas del PIN
    private fun setupPinAutoJump(
        current: EditText,
        next: EditText?,
        previous: EditText?
    ) {
